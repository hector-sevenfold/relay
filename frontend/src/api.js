...
export const api = {
  ...
  getSourceTypes: () => request('/api/source-types'),
  ...
  createSource: (categoryId, payload) => request(`/api/categories/${categoryId}/sources`, { method: 'POST', body: JSON.stringify(payload) }),
  updateSource: (id, payload) => request(`/api/sources/${id}`, { method: 'PUT', body: JSON.stringify(payload) }),
  deleteSource: (id) => request(`/api/sources/${id}`, { method: 'DELETE' }),
  createQuery: (categoryId, payload) => request(`/api/categories/${categoryId}/queries`, { method: 'POST', body: JSON.stringify(payload) }),
